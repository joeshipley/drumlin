...
- **M7** — Full bus FX. In progress:
  ...
  - **Part 2 (next):** transient shaper (new shared-core DSP), parallel/NY comp, tape/stereo delay, reverb send (+ the snare gated-verb path), and a pump rate/curve control.
